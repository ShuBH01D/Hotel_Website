...
function Facilities() {
    return (
        <>
            ...
            <div className='xsm:w-[1000px] xsm:mx-10 xsm:flex xsm:flex-col xsm:justify-center xsm:items-center xsm:mt-5 xsm:space-y-10 xl:w-full xl:space-y-0 xl:flex xl:flex-row xl:mt-[100px] xl:mx-0'>
                <div className='xsm:w-full xsm:h-full xsm:flex-col xl:w-3/6 xl:h-full xl:flex xl:flex-col'>
            ...
            <div className='xl:flex xl:flex-row xl:w-full font-bold xl:h-[390px]  xsm:flex xsm:w-[1100px] xsm:flex-col xsm:justify-center'>
                <div className='xl:w-[40%] font-sans xl:flex xl:justify-start xsm:w-[1100px] xsm:justify-center'>
                    <div className='xl:flex xsm:flex'>
                        <div className='xsm:flex xsm:flex-col xsm:w-full xsm:justify-center xl:flex xl:flex-col xl:p-11 font-[Roboto] xl:space-y-2 xl:pl-16'>
                            <div className='xsm:flex xsm:flex-col xsm:text-center xl:flex xl:p-0 xl:m-0 xl:flex-col'> <span className='font-[Roboto] xl:text-3xl xl:p-0 xl:text-left font-bold text-indigo-500 xsm:text-3xl xsm:p-10'>We also offer:</span>
                            </div>
                            <p className='xl:text-2xl xl:text-left xsm:text-2xl xsm:px-10 xl:px-0  xsm:w-full xsm:text-center'>LIbrary services</p>
                            <p className='xl:text-2xl xl:text-left xsm:text-2xl xsm:px-10 xl:px-0 xsm:text-center'>Free Wi-fi</p>
                            <p className='xl:text-2xl xl:text-left xsm:text-2xl xsm:px-10 xl:px-0 xsm:text-center'>Adequate safety/ security</p>
                            <p className='xl:text-2xl xl:text-left xsm:text-2xl xsm:px-10 xl:px-0 xsm:text-center'>Laundry services</p>
                        </div>
                    </div>
                </div>
                <div className='xl:w-[30%] xl:p-0 font-sans xl:pb-[110px] xsm:pb-0 xl:flex xsm:w-[1100px] xsm:flex xsm:justify-center xsm:flex-col xsm:p-11'>
                ...
                <div className='xl:w-[30%] xl:p-0 xl:pb-[90px] xsm:pb-0 font-sans xl:flex xl:justify-end xsm:p-11 xsm:w-[1100px] xsm:flex xsm:justify-center xsm:flex-col'>
                    <div className='xl:p-11 xl:pb-20 xsm:pb-0 font-[Robo] xl:space-y-2 xsm:space-y-2'>
                        ...
                        <p className='xl:text-2xl xsm:text-2xl xsm:text-center xl:text-left'>Neccessities for babies and <br />children</p>
                    </div>
                </div>
            </div>
            <Footer />
